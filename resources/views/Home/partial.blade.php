    ...
    <ul class="list-unstyled topnav-menu float-right mb-0">
        ...
        <li class="dropdown notification-list">
            <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                <img src= "{{asset('assets/images/users/wifi.jpg') }}" alt="user-image" class="rounded-circle">
                <span class="pro-user-name ml-1">
                    Quốc Cường <i class="mdi mdi-chevron-down"></i> 
                </span>
            </a>
...
<div class="container-fluid">
    <div id="navigation">
        ...
        <ul class="navigation-menu">
            ...
            <li class="has-submenu">
                <a href="{{ route('linhvuc.danh-sach') }}">
                    <i class="la la-cube"></i>Lĩnh vực<div class=""></div></a>
            </li>

            <li class="has-submenu">
                <a href="{{route('cauhoi.danh-sach')}}"> <i class="la la-clone"></i>Câu hỏi </a>

            </li>

            <li class="has-submenu">
                <a href="{{route('nguoichoi.danh-sach')}}"> <i class="la la-briefcase"></i>Người chơi</a>
            ...
            <li class="has-submenu">
                <a href="{{route('goicredit.danh-sach')}}">
